...
exports.NamespaceMetadataTransaction = void 0;
...
class NamespaceMetadataTransaction extends Transaction_1.Transaction {
     ...
     */
    createBuilder() {
        const transactionBuilder = new catbuffer_typescript_1.NamespaceMetadataTransactionBuilder(this.getSignatureAsBuilder(), this.getSignerAsBuilder(), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.NAMESPACE_METADATA.valueOf(), new catbuffer_typescript_1.AmountDto(this.maxFee.toDTO()), new catbuffer_typescript_1.TimestampDto(this.deadline.toDTO()), new catbuffer_typescript_1.UnresolvedAddressDto(this.targetAddress.encodeUnresolvedAddress(this.networkType)), this.scopedMetadataKey.toDTO(), this.targetNamespaceId.toBuilder(), this.valueSizeDelta, this.value);
    ...
    toEmbeddedTransaction() {
        return new catbuffer_typescript_1.EmbeddedNamespaceMetadataTransactionBuilder(this.getSignerAsBuilder(), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.NAMESPACE_METADATA.valueOf(), new catbuffer_typescript_1.UnresolvedAddressDto(this.targetAddress.encodeUnresolvedAddress(this.networkType)), this.scopedMetadataKey.toDTO(), this.targetNamespaceId.toBuilder(), this.valueSizeDelta, this.value);
    }
    /**
     * @internal
     * @returns {NamespaceMetadataTransaction}
...
//# sourceMappingURL=NamespaceMetadataTransaction.js.map