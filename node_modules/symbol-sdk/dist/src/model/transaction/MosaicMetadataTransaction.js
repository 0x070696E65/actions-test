...
exports.MosaicMetadataTransaction = void 0;
...
class MosaicMetadataTransaction extends Transaction_1.Transaction {
    ...
    toEmbeddedTransaction() {
        return new catbuffer_typescript_1.EmbeddedMosaicMetadataTransactionBuilder(this.getSignerAsBuilder(), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.MOSAIC_METADATA.valueOf(), new catbuffer_typescript_1.UnresolvedAddressDto(this.targetAddress.encodeUnresolvedAddress(this.networkType)), this.scopedMetadataKey.toDTO(), new catbuffer_typescript_1.UnresolvedMosaicIdDto(this.targetMosaicId.id.toDTO()), this.valueSizeDelta, this.value);
    }
    /**
     * @internal
...
//# sourceMappingURL=MosaicMetadataTransaction.js.map