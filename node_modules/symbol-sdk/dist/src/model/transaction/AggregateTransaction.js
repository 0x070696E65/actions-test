...
class AggregateTransaction extends Transaction_1.Transaction {
    ...
    static createFromPayload(payload) {
         ...
         */
        const builder = catbuffer_typescript_1.AggregateCompleteTransactionBuilder.loadFromBinary(format_1.Convert.hexToUint8(payload));
    ...
    createBuilder() {
        ...
        const cosignatures = this.cosignatures.map((cosignature) => {
            ...
            return new catbuffer_typescript_1.CosignatureBuilder(cosignature.version.toDTO(), new catbuffer_typescript_1.PublicKeyDto(signerBytes), new catbuffer_typescript_1.SignatureDto(signatureBytes));
        });
        const builder = this.type === TransactionType_1.TransactionType.AGGREGATE_COMPLETE ? catbuffer_typescript_1.AggregateCompleteTransactionBuilder : catbuffer_typescript_1.AggregateBondedTransactionBuilder;
        return new builder(this.getSignatureAsBuilder(), this.getSignerAsBuilder(), this.versionToDTO(), this.networkType.valueOf(), this.type.valueOf(), new catbuffer_typescript_1.AmountDto(this.maxFee.toDTO()), new catbuffer_typescript_1.TimestampDto(this.deadline.toDTO()), new catbuffer_typescript_1.Hash256Dto(this.calculateInnerTransactionHash()), transactions, cosignatures);
    }
    /**
     * @internal
    ...
    calculateInnerTransactionHash() {
        ...
        this.innerTransactions.forEach((transaction) => {
            ...
            const padding = new Uint8Array(catbuffer_typescript_1.GeneratorUtils.getPaddingSize(byte.length, 8));
            hasher.update(catbuffer_typescript_1.GeneratorUtils.concatTypedArrays(byte, padding));
