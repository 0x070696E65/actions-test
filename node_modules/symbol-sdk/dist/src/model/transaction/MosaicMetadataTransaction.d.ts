...
export declare class MosaicMetadataTransaction extends Transaction {
     ...
     */
    static create(deadline: Deadline, targetAddress: UnresolvedAddress, scopedMetadataKey: UInt64, targetMosaicId: UnresolvedMosaicId, valueSizeDelta: number, value: Uint8Array, networkType: NetworkType, maxFee?: UInt64, signature?: string, signer?: PublicAccount): MosaicMetadataTransaction;
    /**
     * @param networkType
     * @param version
     * @param deadline
