...
class Transaction {
    ...
    getSignerAsBuilder() {
        var _a;
        return ((_a = this.signer) === null || _a === void 0 ? void 0 : _a.toBuilder()) || new catbuffer_typescript_1.PublicKeyDto(new Uint8Array(32));
    }
    /**
     * @internal
     *
    ...
    getSignatureAsBuilder() {
        return new catbuffer_typescript_1.SignatureDto(this.signature !== undefined ? format_1.Convert.hexToUint8(this.signature) : new Uint8Array(64));
    }
    /**
     * @internal
     *
