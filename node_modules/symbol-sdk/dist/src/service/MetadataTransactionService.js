    ...
    createMosaicMetadataTransaction(deadline, networkType, targetAddress, mosaicId, key, value, sourceAddress, maxFee) {
        return this.metadataRepository
            ...
            if (metadatas.data.length > 0) {
                ...
                const newValueBytes = Convert_1.Convert.utf8ToUint8(value);
                const xoredBytes = Convert_1.Convert.hexToUint8(Convert_1.Convert.xor(currentValueByte, newValueBytes));
                return MosaicMetadataTransaction_1.MosaicMetadataTransaction.create(deadline, targetAddress, key, mosaicId, newValueBytes.length - currentValueByte.length, xoredBytes, networkType, maxFee);
            }
            const newValueBytes = Convert_1.Convert.utf8ToUint8(value);
            return MosaicMetadataTransaction_1.MosaicMetadataTransaction.create(deadline, targetAddress, key, mosaicId, newValueBytes.length, Convert_1.Convert.utf8ToUint8(value), networkType, maxFee);
        }), (0, operators_1.catchError)((err) => {
            throw Error(err.message);
        }));
    }
