...
class TransactionService {
    ...
    checkShouldResolve(transaction) {
        switch (transaction.type) {
            ...
            case transaction_1.TransactionType.ACCOUNT_MOSAIC_RESTRICTION:
                ...
                return (accountMosaicRestriction.restrictionAdditions.find((mosaicId) => mosaicId.isNamespaceId()) !== undefined ||
            ...
            case transaction_1.TransactionType.HASH_LOCK:
                return transaction.mosaic.id.isNamespaceId();
            ...
            case transaction_1.TransactionType.MOSAIC_METADATA:
                return transaction.targetMosaicId.isNamespaceId();
            case transaction_1.TransactionType.MOSAIC_SUPPLY_CHANGE:
                return transaction.mosaicId.isNamespaceId();
            ...
            case transaction_1.TransactionType.TRANSFER:
                ...
                return (transfer.recipientAddress.isNamespaceId() || transfer.mosaics.find((mosaic) => mosaic.id.isNamespaceId()) !== undefined);
            default:
    ...
    resolvedFromReceipt(transaction, aggregateIndex) {
        ...
        const mosaicResolution = paginationStreamer_1.ReceiptPaginationStreamer.mosaicResolutionStatements(this.receiptRepository)
            .search({ height: transaction.transactionInfo.height })
            .pipe((0, operators_1.toArray)());
        return (0, rxjs_1.combineLatest)(mosaicResolution, addressResolution)
            .pipe((0, operators_1.map)(([mosaic, address]) => {
            return new receipt_1.Statement([], address, mosaic);
        }))
