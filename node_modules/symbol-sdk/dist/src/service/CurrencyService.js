...
class CurrencyService {
    ...
    getNetworkCurrencies() {
        return this.repositoryFactory
            ...
            return this.getCurrencies(mosaicIds).pipe((0, operators_1.map)((networkCurrencies) => {
    ...
    getCurrencies(mosaicIds) {
        ...
        return (0, rxjs_1.forkJoin)({
            mosaicsInfo: (0, rxjs_1.firstValueFrom)(mosaicHttp.getMosaics(mosaicIds)),
            mosaicNames: (0, rxjs_1.firstValueFrom)(namespaceHttp.getMosaicsNames(mosaicIds)),
        }).pipe((0, operators_1.map)(({ mosaicsInfo, mosaicNames }) => mosaicsInfo.map((mosaicInfo) => {
