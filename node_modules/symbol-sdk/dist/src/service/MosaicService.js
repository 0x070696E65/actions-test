...
class MosaicService {
    ...
    mosaicsView(mosaicIds) {
        return (0, rxjs_1.of)(mosaicIds).pipe((0, operators_1.mergeMap)(() => this.mosaicRepository.getMosaics(mosaicIds).pipe((0, operators_1.mergeMap)((info) => info), (0, operators_1.map)((mosaicInfo) => {
    ...
    mosaicsAmountView(mosaics) {
        ...
        return this.mosaicsView(mosaicIds).pipe((0, operators_1.map)((mosaicViews) => {
            const results = [];
    ...
    mosaicsAmountViewFromAddress(address) {
        return (0, rxjs_1.of)(address).pipe((0, operators_1.mergeMap)((_) => this.accountRepository.getAccountInfo(_)), (0, operators_1.mergeMap)((_) => this.mosaicsAmountView(_.mosaics)));
    }
}
