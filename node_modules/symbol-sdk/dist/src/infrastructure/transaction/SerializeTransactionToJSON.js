...
const SerializeTransactionToJSON = (transaction) => {
    ...
    if (transaction.type === transaction_1.TransactionType.ACCOUNT_KEY_LINK) {
    ...
    else if (transaction.type === transaction_1.TransactionType.ACCOUNT_MOSAIC_RESTRICTION) {
    ...
    else if (transaction.type === transaction_1.TransactionType.MOSAIC_ALIAS) {
    ...
    else if (transaction.type === transaction_1.TransactionType.MOSAIC_DEFINITION) {
    ...
    else if (transaction.type === transaction_1.TransactionType.MOSAIC_SUPPLY_CHANGE) {
    ...
    else if (transaction.type === transaction_1.TransactionType.MOSAIC_SUPPLY_REVOCATION) {
        const mosaicSupplyTx = transaction;
        return {
    ...
    else if (transaction.type === transaction_1.TransactionType.MOSAIC_GLOBAL_RESTRICTION) {
    ...
    else if (transaction.type === transaction_1.TransactionType.MOSAIC_ADDRESS_RESTRICTION) {
    ...
    else if (transaction.type === transaction_1.TransactionType.MOSAIC_METADATA) {
        ...
        return {
            ...
            value: __1.Convert.uint8ToHex(mosaicMetadataTx.value),
        };
    }
