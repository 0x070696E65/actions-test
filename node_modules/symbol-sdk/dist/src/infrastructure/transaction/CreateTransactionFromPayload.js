...
const CreateTransactionFromPayload = (payload, isEmbedded = false) => {
    ...
    else if (type === transaction_1.TransactionType.MOSAIC_SUPPLY_REVOCATION) {
        return transaction_1.MosaicSupplyRevocationTransaction.createFromPayload(payload, isEmbedded);
    }
