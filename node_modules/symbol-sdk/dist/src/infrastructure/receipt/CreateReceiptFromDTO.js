...
exports.createTransactionStatement = exports.CreateReceiptFromDTO = exports.createAddressResolutionStatement = exports.createMosaicResolutionStatement = void 0;
 ...
 * @constructor
 */
const createMosaicResolutionStatement = (statementInfoDTO) => {
...
exports.createMosaicResolutionStatement = createMosaicResolutionStatement;
/**
 * @internal
 * @param statementInfoDTO
...
const createBalanceChangeReceipt = (receiptDTO) => {
    return new BalanceChangeReceipt_1.BalanceChangeReceipt(utils_1.DtoMapping.toAddress(receiptDTO.targetAddress), new MosaicId_1.MosaicId(receiptDTO.mosaicId), UInt64_1.UInt64.fromNumericString(receiptDTO.amount), receiptDTO.version, receiptDTO.type);
};
/**
 * @internal
 * @param receiptDTO
...
const createBalanceTransferReceipt = (receiptDTO) => {
    return new BalanceTransferReceipt_1.BalanceTransferReceipt(utils_1.DtoMapping.toAddress(receiptDTO.senderAddress), utils_1.DtoMapping.toAddress(receiptDTO.recipientAddress), new MosaicId_1.MosaicId(receiptDTO.mosaicId), UInt64_1.UInt64.fromNumericString(receiptDTO.amount), receiptDTO.version, receiptDTO.type);
};
/**
 * @internal
