...
class MosaicHttp extends Http_1.Http {
     ...
     */
    getMosaicMerkle(mosaicId) {
        return this.call(this.mosaicRoutesApi.getMosaicMerkle(mosaicId.toHex()), DtoMapping_1.DtoMapping.toMerkleStateInfo);
    }
    /**
    ...
    search(criteria) {
        return this.networkTypeObservable.pipe((0, operators_1.mergeMap)((networkType) => {
            var _a;
            return this.call(this.mosaicRoutesApi.searchMosaics((_a = criteria.ownerAddress) === null || _a === void 0 ? void 0 : _a.plain(), criteria.pageSize, criteria.pageNumber, criteria.offset, DtoMapping_1.DtoMapping.mapEnum(criteria.order)), (body) => super.toPage(body.pagination, body.data, MosaicHttp.toMosaicInfo, networkType));
        }));
    }
    streamer() {
        return new paginationStreamer_1.MosaicPaginationStreamer(this);
    }
    /**
     ...
     */
    static toMosaicInfo(mosaicInfo) {
        return new MosaicInfo_1.MosaicInfo(mosaicInfo.mosaic.version || 1, mosaicInfo.id, new MosaicId_1.MosaicId(mosaicInfo.mosaic.id), UInt64_1.UInt64.fromNumericString(mosaicInfo.mosaic.supply), UInt64_1.UInt64.fromNumericString(mosaicInfo.mosaic.startHeight), DtoMapping_1.DtoMapping.toAddress(mosaicInfo.mosaic.ownerAddress), mosaicInfo.mosaic.revision, new MosaicFlags_1.MosaicFlags(mosaicInfo.mosaic.flags), mosaicInfo.mosaic.divisibility, UInt64_1.UInt64.fromNumericString(mosaicInfo.mosaic.duration));
    }
}
