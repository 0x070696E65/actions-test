...
class AccountHttp extends Http_1.Http {
    ...
    search(criteria) {
        var _a;
        return this.call(this.accountRoutesApi.searchAccounts(criteria.pageSize, criteria.pageNumber, criteria.offset, utils_1.DtoMapping.mapEnum(criteria.order), utils_1.DtoMapping.mapEnum(criteria.orderBy), (_a = criteria.mosaicId) === null || _a === void 0 ? void 0 : _a.toHex()), (body) => super.toPage(body.pagination, body.data, AccountHttp.toAccountInfo));
    }
    streamer() {
    ...
    static toAccountInfo(dto) {
        ...
        }), dto.account.mosaics.map((mosaicDTO) => new mosaic_1.Mosaic(new mosaic_1.MosaicId(mosaicDTO.id), model_1.UInt64.fromNumericString(mosaicDTO.amount))), model_1.UInt64.fromNumericString(dto.account.importance), model_1.UInt64.fromNumericString(dto.account.importanceHeight));
    }
}
